    ...
    class Game
    {
        ...
        public void Play()
        {
            ...
            while (!board.IsFinished(out winnerBoardItem))
            {
                ...
                Console.WriteLine("Jogador da vez: {0} [{1}]", activePlayer.Name, activePlayer.BoardItem);
            ...
            {
                // Se o winnerBoardItem não for null, alguém ganhou o jogo.
        ...
        private void ProcessPlay(string play, Player player)
        {
            ...
            try
            {
                // Faz o parse da jogada. Se o parse não funcionar, lança exeção.
            ...
            catch (ArgumentOutOfRangeException ex)
            {
                ...
                throw new PlayException("A jogada fornecida é inválida.", ex);
            }
        }
        ...
        private void ReadPlayerNames()
        {
            ...
            // Cria os jogadores.
            players[0] = new Player(player1Name, ConsoleColor.Blue, BoardItem.X);
